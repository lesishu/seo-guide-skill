...
可以用于大多数Agent，训练适合自己的任何SEO能力、流程。
...
# 3、references/ — 精炼指南（主工作区）

技能的核心产出物。将 Google + Moz + Ahrefs 三方课程消化为可直接引用的中文操作指南。

| # | 文件名 | 定位 |
|---|--------|------|
| 1 | `tkd-standard.md` | Title / Description / Keywords 写作规范（含长度规格、场景模板、优秀示例） |
| 2 | `keyword-research.md` | 关键词研究完整工作流：工具链 → 意图分类 → 筛选漏斗 |
| 3 | `on-page-seo.md` | 页面优化执行清单：H标签、结构化数据、图片优化、内链策略 |
| 4 | `technical-seo.md` | 技术 SEO 检查项：速度、安全、移动端、爬虫配置 |
| 5 | `content-strategy.md` | 内容规划方法：主题集群、Content Hub、产品驱动内容 |
| 6 | `link-building.md` | 外链策略：Seed Prospects、Lookalike、Blitz List、Outreach |
| 7 | `local-seo.md` | 本地商家 SEO：GBP 优化、NAP 一致性、本地引用 |
| 8 | `seo-principles.md` | 核心原则 + 常见误区辟谣 |
| 9 | `seo-audit.md` | Part A 单页快速诊断 / Part B 全站审计流程 |
| 10 | `seo-tools.md` | 工具推荐：Ahrefs、Moz、Screaming Frog、PageSpeed Insights 等 |
