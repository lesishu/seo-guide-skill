...
If you're seeing a sustained, large drop in position for your site as a whole, read through the [self-assessment](/search/docs/fundamentals/creating-helpful-content) to check if your site overall (not just individual pages) is delivering content that's helpful, reliable, and people first. Specifically, we recommend keeping the following in mind: 
