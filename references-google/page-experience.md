...
> 来源：Google Search Central (https://developers.google.com/search/docs/appearance-page-experience.txt)
...
Here are some resources that can help you measure, monitor, and optimize your page experience: 
  ...
  **Check if a site's connection is secure**: Learn how to check if your site's connection is secure, as reported by Chrome. If the page isn't served over HTTPS, learn how to [secure your site with HTTPS](https://web.dev/articles/enable-https). 
