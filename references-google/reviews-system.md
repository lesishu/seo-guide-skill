...
In the case of products, [product structured data](/search/docs/appearance/structured-data/product) might help us better identify if something is a product review, but we don't solely depend on it. 

## What does this system mean for my site?

To learn more about how to create content that's successful with the reviews system, see our [help page on how to write high quality reviews](/search/docs/specialty/ecommerce/write-high-quality-reviews). 
